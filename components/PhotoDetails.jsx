import { getDictionary } from "@/app/[lang]/dictionarieses";
    ...
    <div className="grid grid-cols-12 gap-4 2xl:gap-10 ">
      ...
      <div className="p-6 border rounded-xl col-span-12 lg:col-span-4  ">
        ...
        <div className="space-y-2.5 text-black/80 text-xs lg:text-sm">
          ...
          <div className="flex justify-between">
            <span>{photo.uploadedOn}</span>
            <span className="font-bold">{photo.uploadedOn}</span>
          </div>
        </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="spacy-y-3">
                ...
                <p className="text-black/60 text-xs lg:text-sm">
                  ...
                  <span className="ml-1">{dictonary.followers}</span>
                </p>
              </div>
            </div>
        ...
        <div className="mt-6">
          <div className="flex items-stretch gap-3">
            <button className="flex-1 border py-1.5 rounded text-xs lg:text-sm flex items-center justify-center text-center gap-1.5 font-bold hover:bg-yellow-400">
              <Image src="/heart.svg" alt="Follow" width={20} height={20} />
              100
            </button>
            <button className="flex-1 border py-1.5 rounded text-xs lg:text-sm flex items-center justify-center text-center gap-1.5 font-bold hover:bg-yellow-400">
              <Image src="/save.svg" alt="Follow" width={20} height={20} />
              {dictonary.save}
            </button>
            <button className="flex-1 border py-1.5 rounded text-xs lg:text-sm flex items-center justify-center text-center gap-1.5 font-bold hover:bg-yellow-400">
              <Image src="/share.svg" alt="Follow" width={20} height={20} />
              {dictonary.share}
            </button>
          </div>
        </div>
